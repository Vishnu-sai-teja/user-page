...
description: Build or refine an About Me page, portfolio, or personal website into an editorial personal site modeled on the Aditi Bhatnagar reference: a calm multi-page profile with writing, projects, bookmarks, recommendations, and long-form narrative instead of a resume dump.
---

# About Me Design

<workflow>
Use this skill when the user asks for an about-me page, personal portfolio, personal homepage, or a site refresh that should feel like a living editorial product instead of a static resume.
...
Use Carbon for concrete component selection, API details, interaction states, and layout primitives.
Use this skill to decide the editorial shell, route roles, content model, and tone.

## 3. Build The Multi-Page System Before Styling

Apply the multi-page design system from `references/design-principles.md` before working on visuals.
...
- Short lowercase route labels
- Minimal wordmark at top left
- Light border under the nav
- Soft translucent header background with blur when useful
...
- Restrained monochrome or near-monochrome palette
- Serif plus sans pairing when the product allows it
- Oversized hero typography
- Lowercase or minimally punctuated labels
- Generous whitespace and quiet rhythm
- Borders, tables, pills, and underlines instead of loud color blocks
- Motion limited to page reveals, nav underline, hover lift, and subtle content transitions

The reference site uses:
- a black, white, and gray palette
- sans for interface copy
- serif accents for editorial tone
- table-heavy archive views

Use those as first-choice constraints unless the existing brand system conflicts.
...
Use Carbon components wherever they improve structure and consistency, but do not let the page start feeling like enterprise admin UI.
Carbon should supply primitives, not determine the aesthetic.
...
- Favor asymmetry and hierarchy over repetitive equal-width cards
- Use typography, tables, and spacing to do most of the work
- Keep interactions subtle and content-led
- Default to white or off-white backgrounds with black and gray structure
- Avoid loud gradients, KPI chips, testimonial carousels, and resume-template grids
...
- The navigation, footer, and motion are quiet and consistent
